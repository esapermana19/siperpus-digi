    ...
    <div class="max-w-4xl mx-auto">
        <div class="mb-4 flex gap-2">
            <a href="{{ route('kategori.create') }}"
                class="inline-flex gap-1 items-center px-4 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
            ...
            @if (request('search'))
                <a href="{{ route('kategori.index') }}" class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600">
                    Reset
                </a>
            @endif
        </form>
